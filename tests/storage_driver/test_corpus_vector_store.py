...
def test_sentence_splitting():
    ...
    doc2 = "There is a total of one sentence division. points expected in this text, That is intended Anything more or less is bad, but I need to have sentence boundaries respected, Who doesn't like respect after all"
    max_seg_size = 50
    ...
    for sentence in sentences:
        assert (len(sentence) <= max_seg_size)
